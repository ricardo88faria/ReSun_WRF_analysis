...
for (j in 1:length(variavs)) {
      ...
      if (png_out == 1) {
            ...
            if (j != 2) {
                  for (i in 1:length(fileNames)) {
                        ...
                        name_png = paste0("output/images/", variavs[j], "_", months_name[i], ".png")
      ...
      if (kml_out == 1) {
            ...
            if (j != 2) {
                  ...
                  KML(get0(variav_name), file = paste0(variavs[j], ".kml"), overwrite = T, #[length(tS_f)]
                      col = color(20), blur = 1) 
