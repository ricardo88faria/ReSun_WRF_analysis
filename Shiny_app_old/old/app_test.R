...
ui <- navbarPage(theme="http://bootswatch.com/spacelab/bootstrap.css", inverse=F,
                   title=div(img(src=".www/img/LREC.png", height = 30, width = 60),
                             img(src=".ReSun.jpg", height = 30, width = 70),
                             "Atlas da Radiação Solar"
                   ),
                   windowTitle="Atlantic Weather Forecast",
                   collapsible=TRUE,
                   id="nav",
