...
A ilha da Madeira apresenta uma topografia muito montanhosa, com profundos vales incrustados entre os picos e suas caraterísticas falésias. A `r figr("topography", TRUE, type="Fig.")`representa a topografia complexa da ilha da Madeira com isolinhas.
...
```{r srtm_topo_mad, warning=F, echo=FALSE, message=FALSE, fig.cap="Topografia SRTM a 100m de resolução da Ilha da Madeira.", anchor = "Figura", fig.retina=1, dpi=100, fig.width=13, fig.height=9}
...
```{r srtm_topo_ps, warning=F, echo=FALSE, message=FALSE, fig.cap="Topografia SRTM a 100m de resolução da Ilha do Porto Santo.", anchor = "Figura", fig.retina=1, dpi=100, fig.width=13, fig.height=9}
...
Na `r figr("hori_ps_N", TRUE, type="Fig.")` pode ser consultado com maior detalhe a informação topográfica de entrada, e o mapa de horizontes para a direção de 0º (Norte) e 90º (Este).

```{r hori_ps_N, echo=FALSE, message=FALSE, fig.cap="Cálculo dos horizontes, direção de Norte e Este no Porto Santo.", anchor = "Figura", fig.retina=1, dpi=100, fig.width=13, fig.height=9, fig.show='hold'}
...
filled.contour(hor_mat_ps[4,,], col = viridis(n = 20, alpha = 1, begin = 0, end = 1, option = "A"), # nlevels = 400, #axes = F #(12), nlev=13,
               ...
               plot.title = title(main = "Horizontes - Este"))
...
filled.contour(hor_mat_ps[27,,], col = viridis(n = 20, alpha = 1, begin = 0, end = 1, option = "A"), # nlevels = 400, #axes = F #(12), nlev=13,
               ...
               key.title = title(main = as.expression(paste("[º]"))),
               plot.title = title(main = "Horizontes - Norte"))
...
colnames(corr_values) <- c("EMA", " Erro abs. [%]", "Rad. Sol. [W/m^2]", "Altura [m]", " Erro abs. corrigido [%]")

kable(corr_values[1:9,], caption = 'Valores de Erro Absoluto, rMB[%], para as EMAS em estudo.', align = "c", digits = 3)
...
\blandscape
```{r IGPH_mad, warning=F, echo=FALSE, message=FALSE, fig.cap="Radiação Global no plano horizontal para a ilha da Madeira, par o TMY.", anchor = "Figura", fig.retina=1, dpi=100, fig.width=13, fig.height=9}
...
\blandscape
```{r IGPH_ps, warning=F, echo=FALSE, message=FALSE, fig.cap="Radiação Global no plano horizontal ilha do Porto Santo, par o TMY.", anchor = "Figura", fig.retina=1, dpi=100, fig.width=13, fig.height=9}
