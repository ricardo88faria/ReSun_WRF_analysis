...
Nas seguintes Figuras pode ser consultada a evolução da frequência cumulativa diária da radiação global e Temperatura para cada um dos meses do TMY.

#### Para os valores de Radiação medidos:
![Título.](ReSun/tmy/Irradiance_CDF Monthly_Ja_Ap.png)
![jfffjf.](ReSun/tmy/Irradiance_CDF Monthly_My_Ag.png)
![Cklj.](ReSun/tmy/Irradiance_CDF Monthly_Sp_Dc.png)

#### Para os valores de Tempreatura medidos:
![cjllclnb.](ReSun/tmy/Temperature_CDF Monthly_Ja_Ap.png)
![,mn,b,e.](ReSun/tmy/Temperature_CDF Monthly_My_Ag.png)
![vhkvhuuu.](ReSun/tmy/Temperature_CDF Monthly_Sp_Dc.png)
...
A `r figr("IGPH_mad", TRUE, type="Tab.")`, `r figr("IGPH_ps", TRUE, type="Tab.")` que se segue apresenta a disponibilidade da média anual da radiação global diária em plano horizontal para o ano meteorológico típico.
