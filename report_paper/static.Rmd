...
library(knitr)
library(kfigr)
knitr::opts_chunk$set(echo = TRUE, dev = 'pdf', dpi=200)
...
O [LREC](<http://http://www.lrec.pt>) dispõe de uma vasta rede de Estações Meteorológicas Automáticas (EMA) distribuidas por toda a ilha, representada na `r figr("third-est_tab", link = TRUE, type="tab")`

```{r ggmap, echo=FALSE, message=FALSE, fig.align='center', fig.cap = "posição das estações", anchor = "fig"}
library(ggmap)
...
```{r est_tab, echo=FALSE, message=FALSE, anchor = "tab"}
kable(data)
```
...
```{r topography, echo=FALSE, message=FALSE, fig.cap="topografia.", ref.label="fig2"}
